...
meta_dispatch_expected_failures = {
    ...
    aten.segment_reduce.out : {bf16, f32, f16, f64},
...
meta_dispatch_device_skips['cpu'] = {
    ...
    aten.native_batch_norm.out: {f32, f64},
    ...
    def _run_dispatch_meta_test(self, device, dtype, op, symbolic_meta, inplace, all_stride_variants=False):
        ...
        for sample_input in samples:
            ...
            for args in strided_args:
                with MetaCrossRefDispatchMode.push(self, dtype=dtype, device=device, symbolic_meta=symbolic_meta, inplace=inplace, supports_out=op.supports_out):
                    expected = func(*args, **kwargs)
